  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={[styles.row, styles.headerRow]}>
        ...
        <Text style={[styles.cell, styles.headerText]}>Alert</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.cell}>Cipla</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.cell}>Spenser</Text>
        <Text style={styles.cell}>10</Text>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.cell}>HenrySchein</Text>
